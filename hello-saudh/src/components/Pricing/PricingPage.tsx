...
const PricingPage = () => {
    ...
    return (
      <div className="border-b border-gray-200 py-3 sm:py-4">
        <button
          ...
          className="w-full flex items-center justify-between text-left py-2 font-medium text-sm sm:text-base text-gray-900 hover:text-[#ffd00a] transition-colors gap-4"
        >
        ...
        {isOpen && (
          <motion.div
            ...
            className="text-sm sm:text-base text-gray-600 mt-2 pr-8 sm:pr-12"
          >
            {answer}
          </motion.div>
        )}
  ...
  return (
    <>
      <Navbar />
      <main className="bg-white pt-[70px] min-h-screen">
        {/* Hero Section */}
        <section className="relative pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <div className="inline-flex items-center rounded-full border px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium bg-[#ffd00a]/10 text-gray-900 mb-6 sm:mb-8 border-[#ffd00a]/20">
                <span className="flex h-2 w-2 rounded-full bg-[#ffd00a] mr-2"></span>
                <span className="whitespace-nowrap">Elevate your dining experience</span>
              </div>
              
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-gray-900 mb-4 sm:mb-6 px-2">
                Turn Guests into <span className="text-[#ffd00a]">Loyal Fans</span>
              </h1>
              
              <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-8 sm:mb-10 px-4">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-12 sm:mb-20 px-4">
                <button 
                  ...
                  className="px-6 sm:px-8 py-2.5 sm:py-3 bg-[#ffd00a] text-gray-900 text-base sm:text-lg font-medium rounded-lg hover:bg-[#ffbd00] transition-colors w-full sm:w-auto"
                >
                  View Pricing
                </button>
                <button className="px-6 sm:px-8 py-2.5 sm:py-3 border-2 border-gray-300 text-gray-900 text-base sm:text-lg font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 w-full sm:w-auto">
                  Book a Demo <ArrowRight className="h-4 w-4" />
                </button>
              </div>

              {/* Quick Feature Tickers */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto border-t border-gray-200 pt-6 sm:pt-8 text-gray-600 px-4">
        ...
        <section id="services" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-3 sm:mb-4 text-gray-900 px-2">The Complete Guest Journey</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center mb-12 sm:mb-16 md:mb-24">
              <motion.div 
                ...
                viewport={{ once: true }}
                className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white order-2 lg:order-1"
              >
                <div className="w-full h-64 sm:h-80 md:h-96 bg-gradient-to-br from-[#ffd00a]/20 to-[#ffd00a]/5 flex items-center justify-center">
                  <div className="text-center p-4 sm:p-6 md:p-8">
                    <QrCode className="h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 text-[#ffd00a] mx-auto mb-3 sm:mb-4" />
                    <p className="text-sm sm:text-base text-gray-600">Saudh Services Ecosystem</p>
                  </div>
                </div>
              </motion.div>
              ...
              <div className="space-y-4 sm:space-y-6 md:space-y-8 order-1 lg:order-2">
                {servicesFeatures.map((feature, index) => (
                  <motion.div 
                    ...
                    className="flex gap-3 sm:gap-4 items-start p-3 sm:p-4 rounded-xl hover:bg-white transition-colors duration-200"
                  >
                    <div className={`p-2 sm:p-3 rounded-lg ${feature.color} shrink-0`}>
                      <feature.icon className="w-5 h-5 sm:w-6 sm:h-6" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-lg sm:text-xl mb-1 sm:mb-2 text-gray-900">{feature.title}</h3>
        ...
        <section id="pricing" className="py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-visible">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              <motion.h2
                className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-3 sm:mb-4 text-gray-900 px-2"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <span className={`text-xs sm:text-sm font-medium ${!isAnnual ? 'text-gray-900' : 'text-gray-500'}`}>Monthly</span>
                <button
                  onClick={() => setIsAnnual(!isAnnual)}
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#ffd00a] focus:ring-offset-2 ${isAnnual ? 'bg-[#ffd00a]' : 'bg-gray-300'}`}
                  role="switch"
                ...
                <span className={`text-xs sm:text-sm font-medium ${isAnnual ? 'text-gray-900' : 'text-gray-500'}`}>
                  Yearly <span className="text-[#ffd00a] font-bold ml-1">(Save 10%)</span>
                </span>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto pt-4 sm:pt-6 md:pt-8">
              {plans.map((plan, index) => (
                ...
                >
                  {plan.popular && (
                    <div className="absolute -top-4 sm:-top-6 left-1/2 -translate-x-1/2 z-20 w-28 sm:w-32 bg-[#ffd00a] text-gray-900 text-xs font-bold px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-center uppercase tracking-wide shadow-lg">
                      Most Popular
                    </div>
                  )}
                  
                  <div className={`h-full flex flex-col bg-white border-2 rounded-2xl shadow-sm hover:shadow-md transition-shadow ${plan.popular ? 'border-[#ffd00a] shadow-xl md:scale-105' : 'border-gray-200'}`}>
                    <div className="p-4 sm:p-5 md:p-6">
                      <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{plan.name}</h3>
                      <p className="text-sm sm:text-base text-gray-600 min-h-[40px] sm:min-h-[50px] mt-2 mb-4 sm:mb-6">{plan.description}</p>
                      
                      <div className="mb-4">
                        {plan.monthlyPrice === "Custom" ? (
                          <div>
                            <span className="text-3xl sm:text-4xl font-bold text-gray-900">Custom</span>
                            <div className="text-xs sm:text-sm text-gray-500 mt-2">Contact for annual volume discounts</div>
                          </div>
                        ) : (
                          <div>
                            <div className="flex items-baseline gap-1">
                              <span className="text-xl sm:text-2xl font-normal text-gray-700">₹</span>
                              <span className="text-3xl sm:text-4xl font-bold text-gray-900">
                                {isAnnual ? plan.annualPrice : plan.monthlyPrice}
                              </span>
                              <span className="text-sm sm:text-base text-gray-500 ml-1">/mo</span>
                            </div>
                      ...
                      <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                        {plan.features.map((feature, i) => (
                          <div key={i} className="flex items-start gap-2">
                            <Check className="h-4 w-4 sm:h-5 sm:w-5 text-[#ffd00a] shrink-0 mt-0.5" />
                            <span className={`text-xs sm:text-sm ${feature.includes('Everything in Starter') ? 'font-semibold text-gray-900' : 'text-gray-700'}`}>
                              {feature}
                            </span>
                          </div>
                        ))}
                    ...
                    <div className="p-4 sm:p-5 md:p-6 pt-0 mt-auto">
                      <button
                        className={`w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg text-sm sm:text-base font-medium transition-colors ${
                          plan.popular
                            ? 'bg-[#ffd00a] hover:bg-[#ffbd00] text-gray-900'
        ...
        <section id="faq" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-center mb-8 sm:mb-10 md:mb-12 text-gray-900 px-2">Frequently Asked Questions</h2>
        ...
        {/* CTA Section */}
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 bg-gray-50">
          <div className="max-w-5xl mx-auto bg-gradient-to-r from-[#ffd00a] to-[#ffbd00] rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-center text-gray-900 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <button className="px-6 sm:px-8 py-3 sm:py-4 bg-gray-900 text-white hover:bg-gray-800 rounded-lg text-base sm:text-lg font-medium transition-colors w-full sm:w-auto">
                Get Started Now
              </button>
            </div>
            
            {/* Decorative circles */}
            <div className="absolute top-0 left-0 w-32 sm:w-48 md:w-64 h-32 sm:h-48 md:h-64 bg-white/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
            <div className="absolute bottom-0 right-0 w-32 sm:w-48 md:w-64 h-32 sm:h-48 md:h-64 bg-black/10 rounded-full blur-3xl translate-x-1/2 translate-y-1/2" />
          </div>
        </section>
      </main>
      <Footer />
